...
ttk.Label(frame, text="Macros disponíveis:").grid(row=0, column=0, columnspan=2, sticky=tk.W, pady=5)
...
lista_macros.grid(row=1, column=0, columnspan=2, sticky=(tk.W, tk.E))
